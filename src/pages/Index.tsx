...
import { BarChart3, PieChart, ScatterChart, Database, Github, SunMoon } from 'lucide-react';
          ...
          {rawData.length === 0 && (
            <div className="text-center py-12">
              ...
              <p className="text-xl text-muted-foreground max-w-xl mx-auto mb-8">
                Upload your data and explore powerful 3D visualizations with detailed insights
              </p>
            </div>
          )}
